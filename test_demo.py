...
def select_model(args, device):
    ...
    if model_id == 10:
        ...
        from models.team10_mlrn import MLRN
        #from sdfmn import SDFM
        name, data_range = f"{model_id:02}_MLRN_baseline", 255.0
        model_path = os.path.join('model_zoo', '10_mlrn.pt')
        model = MLRN()
