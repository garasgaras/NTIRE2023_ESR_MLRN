...
class MLRB(nn.Module):
    """
    Nixer based Local Residual Block (RLFB).
    """
...
class MLRN(nn.Module):
    ...
    Model definition of MLRN in `Mixer based Residual Feature Network for 
    ...
    def __init__(self,
        ...
        self.block_1 = MLRB(feature_channels)
        self.block_2 = MLRB(feature_channels)
        self.block_3 = MLRB(feature_channels)
        self.block_4 = MLRB(feature_channels)
        ...
        self.up_bicubic=nn.Upsample(scale_factor=4, mode='bilinear')                                          
    ...
    def forward(self, x):
        ...
        outputup=self.up_bicubic(x)  
        return output  +outputup
